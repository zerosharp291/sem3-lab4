...
int main()
{
    ...
    for (long long i = 0; i < days_count - 1; i++)
    {
        ...
        else
        {
            ...
            {
                if (fridge[0].get_rating() < buff_rating)
                {
                    count_of_refusales++;
                }
            ...
            {
                if (buff_rating >= fridge.back().get_rating())
                {
                    fridge.push_back(Ice_cream(buff_name, buff_rating, 0));
                }
                else
